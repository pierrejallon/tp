...
class mainWindow(QMainWindow):
    def __init__(self,handler):
        ...
        self.setWindowTitle("Test Julie")
        ...
        duree_affichage=1
        # self.ch0PlotWidget = plotWidget(duree_affichage,1.0 / self.fe,['b'],['channel 1'])
        # self.ch1PlotWidget = plotWidget(duree_affichage,1.0 / self.fe,['b'],['channel 2'])
        ...
        # init filter
        self.filter_b = np.array([1,1,1,1,1])
